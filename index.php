			...
			<div class="accordion">
				<div class="accordion-section">
					...
					<div id="accordion-1" class="accordion-section-content open" style="display:block;">
						<p>Our consultancy led approach to service covers all aspects of Identity and Access Management for Enterprise, Cloud and Mobile.</p>
						<a class="button" href="#">Find out more</a>
					</div>
				</div>

				<div class="accordion-section">
					<a class="accordion-section-title" href="#accordion-2">Data Security and Privacy</a>
					<div id="accordion-2" class="accordion-section-content">
						<p>Identity Methods offers comprehensive client data masking solutions, operating on a mixture of database platforms, using obfuscation, redaction, strong encryption and other masking techniques via enterprise deployment or as a service.</p>
						<a class="button" href="#">Find out more</a>
					</div>
				</div>

				<div class="accordion-section">
					<a class="accordion-section-title" href="#accordion-3">Cyber Security</a>
					<div id="accordion-3" class="accordion-section-content">
						<p>We work with our clients to analyse cyber vulnerabilities and reduce the attack surface using such standards as ISO27001:2013, NIST 800-53, SANS 20 and OWASP. We focus down on the points that matter and create solutions that work.</p>
						<a class="button" href="#">Find out more</a>
					</div>
				</div>
			</div>
